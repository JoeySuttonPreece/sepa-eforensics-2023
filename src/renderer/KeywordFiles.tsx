...
const KeywordFilesComponent =  ({keywordFiles} : {keywordFiles: KeywordFile[]}) => {
    return (
        <table>
            ...
            {keywordFiles?.map((keyword, index) => {
                return (
                    <tr key={index}>
                        ...
                        <td>{keyword.matches.map((value:string) => {
                            return <span>{value} </span>
                        })}</td>
                        <td>{keyword.file.mtime}<br/>{keyword.file.atime}<br/>{keyword.file.ctime}</td>
