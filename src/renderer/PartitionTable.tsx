...
const PartitionTableComponent =  ({partitionTable} : {partitionTable: PartitionTable}) => {
    return (
        <table>
            <caption>Partition Table</caption>
            <thead>
                <tr><td colSpan={4}><strong>Table Type:</strong> {partitionTable.tableType}</td></tr>
                <tr><td colSpan={4}><strong>Sector Size:</strong> {partitionTable.sectorSize}</td></tr>
            </thead>
            <tr>
                <th>Description</th>
                <th>Start</th>
