import { PartitionTable } from 'app-core/domain/volume-system-tools';

const PartitionTableComponent = ({
  header,
  partitionTable,
}: {
  header: string;
  ...
  return (
    <table>
      ...
      <thead>
        <tr>
          <td>Table Type: {partitionTable?.tableType}</td>
        </tr>
        <tr>
          <td>Sector Size: {partitionTable?.sectorSize}</td>
        </tr>
      </thead>
      <tr>
        <th>Description</th>
